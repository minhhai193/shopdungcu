...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 07, 2020 lúc 05:49 AM
...
CREATE TABLE `tbl_post` (
  ...
  `content` varchar(2550) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `image` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tbl_post` (`postId`, `postName`, `description`, `content`, `image`) VALUES
(12, 'Võ đạo và võ thuật', 'Trong võ học có một loại thuốc bổ sung sinh lực', '<p>Nội dung bài viết.</p>\r\n', '8c903aa071.png'),
(14, 'Khái niệm Võ và Võ thuật', 'Tuy có thể đồng nhất “Võ” và “Võ thuật”, nhưng thực ra hai khái niệm ít nhiều vẫn có ranh giới. “Võ”, nói chung, chỉ lối đánh nhau bằng tay không hay binh khí, và đôi khi, nhằm chỉ một bộ môn đối lập với “văn”; còn “võ thuật” lại thiên về nghệ thuật vận đ', '<p><strong>Tuy có thể đồng nhất “Võ” và “Võ thuật”, nhưng thực ra hai khái niệm ít nhiều vẫn có ranh giới. “Võ”, nói chung, chỉ lối đánh nhau bằng tay không hay binh khí, và đôi khi, nhằm chỉ một bộ môn đối lập với “văn”; còn “võ thuật” lại thiên về nghệ ', 'bf3b47926e.jpg');
