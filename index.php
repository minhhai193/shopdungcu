            ...
            <div class="showsanpham">
                <div class="row">
                    <?php
                        ...
                        foreach($product_feathered as $key => $result_new){
                    ?>
                    <div class="col-x">
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="col-x">
                            <div class="khungsanpham mr-2 ml-2 mt-2">
                                <div class="img">
                                    <a href="details.php?proid=<?php echo $result_new['productId']?>"><img src="admin/uploads/<?php echo $result['image']?>"></a>
                                </div>
                                <div class="details text-center">
                                    <a href="details.php?proid=<?php echo $result_new['productId']?>">
                       ...
                       <div class="title_gioithieu pt-5 mb-3">
                        ...
                        <ul class="simplyscroll_post ul">
                            <?php
                                ...
                                if($showpost){
                                    while($result_post= $showpost->fetch_assoc()){
                            ?>
                            <li class="items">
                                <div class="img">
                                    <img src="admin/uploads/<?= $result_post['image'] ?>">
                                </div>
                                <div class="details">
                                    <h3><a href="post_details.php?postid=<?= $result_post['postId']?>"><?= $result_post['postName'] ?></a></h5>
                                    <p>
                                    <?php 
                                    $description = $result_post['description'];
